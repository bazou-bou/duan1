                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <div class="post-block ">
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-img">
                                    <img src="view/images/post_big_img_1.jpg" alt="" class="img-responsive">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <ul class="comment-list">
                                        <li>
                                            <div class="comment-author"><img src="view/images/user_img_1.jpg" alt=""
                                    ...
                                    <ul class="comment-list">
                                        <li>
                                            <div class="comment-author"><img src="view/images/user_img_2.jpg" alt=""
                                                                             class="img-circle"></div>
                                            <div class="comment-info">
                                                <div class="comment-header">
                                            ...
                                            <ul class="childern">
                                                <li>
                                                    <div class="comment-author"><img src="view/images/user_img_3.jpg"
