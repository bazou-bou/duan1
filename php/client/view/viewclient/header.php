...
<head>
    ...
    <!-- Bootstrapppppp -->
    <link href="../viewclient/css/bootstrap.min.css" rel="stylesheet">
    
    <!-- Style CSS -->
    <link href="../viewclient/css/style.css" rel="stylesheet">
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i" rel="stylesheet">
    <!-- owl-carousel -->
    <link href="../viewclient/css/owl.carousel.css" rel="stylesheet">
    <link href="../viewclient/css/owl.theme.default.css" rel="stylesheet">
    <!-- FontAwesome CSS -->
    <link href="../viewclient/css/font-awesome.min.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-8">
                <div class="logo">
                    <a href="home.php"><img src="../viewclient/images/logo.png" alt=""> </a>
                </div>
            </div>
            <!-- /.logo -->
            <!-- search -->
